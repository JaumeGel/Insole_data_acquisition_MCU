...
static uint8_t Sensor_DeviceInit(uint8_t TxPower);
...
/*
 *  @brief  BlueNRG-2 characteristic data updater
 *
 *  @param  Resistive[] Array of 15 Resistive readings
 *  @param  Capacitive[] Array of 15 Capacitive Readings
